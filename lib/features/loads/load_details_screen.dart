              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildDetailRow(
                      'مبدا:',
                      _loadDetails!['origin_full'] ??
                          _loadDetails!['origin_city'],
                    ),
                    _buildDetailRow(
                      'مقصد:',
                      _loadDetails!['dest_full'] ?? _loadDetails!['dest_city'],
                    ),
                    _buildDetailRow(
                      'نوع کرایه:',
        ...
        child: Container(
          ...
          child: SizedBox(
            ...
            child: ElevatedButton.icon(
              onPressed: () => _initiateCallAndLog(
                _loadDetails!['phone_coordination'] ?? '',
              ),
